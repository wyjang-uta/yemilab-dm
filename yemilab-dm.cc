...
//
/// \file yemilab-dm.cc
/// \brief Main function of the YDM example
...
int main(int argc,char** argv)
{
  ...
  runManager->SetUserInitialization(new YDMDetectorConstruction());
  ...
  */
  ...
  runManager->SetUserInitialization(new YDMActionInitialization());
